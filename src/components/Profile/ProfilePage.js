...
import { IconPhone, IconEmail, IconHome } from "@aws-amplify/ui-react";
  ...
  async function updateThisUser() {
    if (
      ...
      try {
        ...
        if (editUser) {
          const newAddress = {
            id: currentUser.company.companyAddressId,
                  ...
                  >
                    ...
                    <Row className="m-2">
                      <Col>
                        ...
                        <input
                          onChange={(event) =>
                            setInput("company", event.target.value)
                          }
                    ...
                    <Row className="m-2 mt-3">
                      ...
                      <Col md="12" className="mt-2">
                        <input
                          onChange={(event) =>
                            setInput("address2", event.target.value)
                          }
                      ...
                      <Col className="mt-2">
                        <input
                          onChange={(event) =>
                            setInput("zip", event.target.value)
                          }
                          value={formState.zip}
                          placeholder="Zip"
                        />
                  ...
                  <Row>
                    <Col className="side-bar-contact-container" xs="11" sm="6">
                      <Row className="contact-container-row">
                        <Col xs="12" sm="4">
                          <span className="contact-container-icon">
                            {" "}
                            <IconHome />{" "}
                          </span>{" "}
                          Address:
                        ...
                        <Col xs="12" sm="8" className="contact-information">
                          ...
                          {currentUser.company.address.state}{" "}
                          {currentUser.company.address.zip}
                        </Col>
                      </Row>
